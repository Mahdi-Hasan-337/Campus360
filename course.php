<?php include '../Campus360/includes/indexitems/header_code.php'; ?>
...
<div class="container-fluid" style="margin:0; padding:0; box-sizing:border-box">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
            <div class="lately-blog-card m-3">
              <figure class="card-banner">
                <img src="assets/images/course/python.jpg" loading="lazy" alt="C++ is an extension of the C programming language">
              </figure>
              <div class="card-content">
                <h3>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
            <div class="lately-blog-card m-3">
              <figure class="card-banner">
                <img src="assets/images/course/CSS.jpg" loading="lazy" alt="CSS (Cascading Style Sheets) is a styling language">
              </figure>
              <div class="card-content">
                <h3>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
            <div class="lately-blog-card m-3">
              <figure class="card-banner">
                <img src="assets/images/course/PHP.jpg" loading="lazy" alt="Python is a high-level programming language">
              </figure>
              <div class="card-content">
                <h3>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
            <div class="lately-blog-card m-3">
              <figure class="card-banner">
                <img src="assets/images/course/html.jpg" loading="lazy" alt="Python is a high-level programming language">
              </figure>
              <div class="card-content">
                <h3>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
            <div class="lately-blog-card m-3">
              <figure class="card-banner">
                <img src="assets/images/course/ds.jpg" loading="lazy" alt="Python is a high-level programming language">
              </figure>
              <div class="card-content">
                <h3>
        ...
        <div class="row">
          <div class="col text-center">
            <a href="includes/course/loadMorePage.php" id="loadMoreBtn" class="py-1 px-3 fs-5 fw-bold my-5 border-0 rounded" style="background-color:light-gray; cursor:pointer;" onclick="load()">Load More</a>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide m-3">
                <div class="blog-card">
                  <figure class="card-banner img-holder">
                    <img src="assets/images/course/C.jpg" loading="lazy" alt=" C language is a versatile and widely used programming language " class="img-cover">
                  </figure>
                  <div class="card-content">
                    <h3 class="h5">
                      <a href="C.php" class="card-title hover:underline">
              ...
              <li class="splide__slide m-3">
                <div class="blog-card">
                  <figure class="card-banner img-holder">
                    <img src="assets/images/course/c++.jpg" loading="lazy" alt=" C++ is an extension of the C programming language " class="img-cover">
                  </figure>
                  <div class="card-content">
                    <h3 class="h5">
                      <a href="C++.php" class="card-title hover:underline">
  ...
  <?php include '../Campus360/includes/indexitems/footer.php'; ?>
  <?php include '../Campus360/includes/indexitems/footer_code.php'; ?>
