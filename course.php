        ...
        <div class="splide__track">
          <ul class="splide__list">
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/python.jpg" loading="lazy" alt="Python is a high-level programming language">
                </figure>
            ...
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/C.jpg" loading="lazy" alt=" C language is a versatile and widely used programming language">
                </figure>
                <div class="card-content">
                  <h3>
            ...
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/c++.jpg" loading="lazy" alt=" C++ is an extension of the C programming language">
                </figure>
                <div class="card-content">
                  <h3>
                    <a href="C++.php" class="card-title">
            ...
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/java.png" loading="lazy" alt="Java is a versatile and platform-independent programming language">
                </figure>
                <div class="card-content">
                  <h3>
            ...
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/html.jpg" loading="lazy" alt="HTML (Hypertext Markup Language) is the standard language">
                </figure>
                <div class="card-content">
                  <h3>
            ...
            <li class="splide__slide">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/ds.jpg" loading="lazy" alt="Data structures are organized formats for efficiently storing">
                </figure>
                <div class="card-content">
                  <h3>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/ai.jpg" loading="lazy" alt="Python is a high-level programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="AI.php" class="card-title">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/algo.jpg" loading="lazy" alt="C language is a versatile and widely used programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="algo.php" class="card-title">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/DE.jpeg" loading="lazy" alt="C++ is an extension of the C programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="DE.php" class="card-title">
                  Digital Electronics
                </a>
              </h3>
              <p class="card-text">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/micro.jpg" loading="lazy" alt="Java is a versatile and platform-independent programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="Micro.php" class="card-title">
                  Microprocessors
                </a>
              </h3>
              <p class="card-text">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/mysql.jpg" loading="lazy" alt="CSS (Cascading Style Sheets) is a styling language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="MySql.php" class="card-title">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/oop.jpg" loading="lazy" alt="Python is a high-level programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="OOP.php" class="card-title">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/react.png" loading="lazy" alt="Python is a high-level programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="React.php" class="card-title">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12 ">
          <div class="lately-blog-card m-3">
            <figure class="card-banner">
              <img src="assets/images/course/VLSI.jpeg" loading="lazy" alt="Python is a high-level programming language">
            </figure>
            <div class="card-content">
              <h3>
                <a href="VLSI.php" class="card-title">
                  VLSI Technology.
                </a>
              </h3>
              <p class="card-text">
      ...
      <div class="row">
        <div class="col text-center">
          <a href="load_more.php" target="_blank" class="py-1 px-3 fs-5 fw-bold my-5 border-0 rounded" style="background-color:light-gray; cursor:pointer;">Load More</a>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="splide__track">
          <ul class="splide__list">
            <li class="splide__slide m-3">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/blog.jpg" loading="lazy" alt=" C language is a versatile and widely used programming language " class="img-cover">
                </figure>
                <div class="card-content">
                  <h3 class="h5">
                    <a href="blog.php" class="card-title hover:underline">
            ...
            <li class="splide__slide m-3">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/job.jpeg" loading="lazy" alt=" C++ is an extension of the C programming language " class="img-cover">
                </figure>
                <div class="card-content">
                  <h3 class="h5">
                    <a href="./job_part.php" class="card-title hover:underline">
                      Prepared yourself for your future. Take a new step right now and give you a one more chance...
                    </a>
                  </h3>
                </div>
              </div>
            ...
            <li class="splide__slide m-3">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/java.jpg" loading="lazy" alt=" ava is a versatile and platform-independent programming language " class="img-cover">
                </figure>
                <div class="card-content">
                  <h3 class="h5">
                    <a href="Java.php" class="card-title hover:underline">
            ...
            <li class="splide__slide m-3">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/html.jpg" loading="lazy" alt=" HTML (Hypertext Markup Language) is the standard language " class="img-cover">
                </figure>
                <div class="card-content">
                  <h3 class="h5">
                    <a href="HTML.php" class="card-title hover:underline">
            ...
            <li class="splide__slide m-3">
              <div class="blog-card">
                <figure class="card-banner img-holder">
                  <img src="assets/images/course/PHP.jpg" loading="lazy" alt=" PHP is a widely used server-side scripting language for  " class="img-cover">
                </figure>
                <div class="card-content">
                  <h3 class="h5">
                    <a href="PHP.php" class="card-title hover:underline">
