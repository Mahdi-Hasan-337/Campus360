  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body" style="padding: 2rem;">
        <form action="passtodltAction.php" method="post">
          ...
          <div class="input-box">
            ...
            <!-- Correct the function call to togglePasswordVisibility('l_pass') -->
            <i class="toggle-password fa-solid fa-eye-slash pwd_hide" onclick="togglePasswordVisibility('l_pass')" style="color:#707070; font-size: 0.9rem;"></i>
          </div>
