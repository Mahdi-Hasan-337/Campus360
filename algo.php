...
<link rel="stylesheet" href="assets/css/course/algo.css">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <td class="py-3">
                    <ol>
                      <li><a href="includes/course/Constructionsms.php">Youtube Link</a></li>
                    </ol>
                  </td>
                </tr>
                <tr>
            ...
            <table class="table table table-bordered">
              ...
              <tbody>
                <tr>
                  <td class="py-3">
                    <ol>
                      <li><a href="includes/course/Constructionsms.php">Website</a></li>
                    </ol>
                  </td>
                </tr>
                <tr>
