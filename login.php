            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <form action="loginAction.php" method="post">
                    ...
                    <div class="input-box">
                        ...
                        <i class="toggle-password fa-solid fa-eye-slash pwd_hide" onclick="togglePasswordVisibility()" style="color:#707070; font-size: 0.9rem;"></i>
                    </div>
                    ...
                    <!-- <button type="Register" class="btn btn-primary col-12">Login</button> -->
                    <button class="button">Login</button>
                    <div class="login-signup">
                        Already have an account? <a href="register.php" class="signup-txt">Signup</a>
                    </div>
                </form>
            </div>
        </div>
